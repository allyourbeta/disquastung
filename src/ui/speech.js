...
(function () {
  ...
  // public/ assets are served from a stable root path regardless of how
  // Vite bundles this script itself, so hardcode it (Vite bundling breaks
  // the old document.currentScript-relative derivation).
  var AUDIO_BASE = "/audio/squares/";
